...
# 1877-device corpus. The reject table is the set of look-alikes a
# trailing-integer parser gets wrong. Keep in sync with the Go twin's table in
...
ACCEPT = {
    ...
    "BDI100": 100, "svi9": 9, "vlan1": 1, "vlan4094": 4094,
}
