...
The full list of vendor device files is available [here](https://github.com/netboxlabs/orb-agent/tree/release/orb-discovery/snmp-discovery/data/lookup_extensions).
