...
func TestSplitList(t *testing.T) {
	tests := []struct {
		...
		{name: "single name", in: "GNMI_PASSWORD", want: []string{"GNMI_PASSWORD"}},
		{name: "spaces are trimmed", in: " GNMI_PASSWORD , GNMI_USERNAME ", want: []string{"GNMI_PASSWORD", "GNMI_USERNAME"}},
		{name: "empty entries are dropped", in: ",GNMI_PASSWORD,,", want: []string{"GNMI_PASSWORD"}},
