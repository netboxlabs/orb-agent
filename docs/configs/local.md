...
For the full `agent.yaml` schema — including all top-level keys, backends, secrets manager, and environment variable substitution — see the [Agent Configuration File reference](agent_yaml.md).
